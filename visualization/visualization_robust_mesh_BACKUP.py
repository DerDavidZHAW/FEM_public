...
# Parameters --------------------------------------------------------------------------------------
# file_path = "output/Annual_balance_ch3.csv"

# file_path_org = "output/aggregated/robust_re8/Annual_balance_ch.csv"  # output/aggregated/robust_part1/Annual_balance_ch_all_old.csv
# file_path_news = "output/aggregated/robust_re9/Annual_balance_ch.csv" 
# file_path = "output/aggregated/RE_RTN_GASN/Annual_balance_ch.csv" 
# file_path = "output/aggregated/RE_R45_GASN/Annual_balance_ch.csv" 
# file_path = "output/aggregated/RE_RTN_GASY/Annual_balance_ch.csv"
file_path = "output/aggregated/cheap_rob_all/Annual_balance_ch.csv"


# def replace_all_columns(file1, file2, output_file):
#     # Read the CSV files with the first column as index
#     df1 = pd.read_csv(file1, index_col=0)
#     df2 = pd.read_csv(file2, index_col=0)
    
#     for col in df2.columns:
#         # replcae the column values in df1 with values from df2
#         df1[col] = df2[col]
    
    
#     # Save the modified df2 to a new file
#     df1.to_csv(output_file)
#     print(f"Updated file saved as {output_file}")


# replace_all_columns(file_path_org, file_path_news, file_path)
...
# basic data cleaning and data manipulation -------------------------------------------------------
