...
# NEXUS-E data set (except for nulcear plants (lazards) and battery and hydrogen from Moretti)
    'investment_cost_chfMW': {
        'pvrf':             {2020: o_m_share * 615000, 2025: o_m_share * 615000, 2030: o_m_share * 615000, 2035: o_m_share * 697000, 2040: o_m_share * 615000, 2045: o_m_share * 615000, 2050: o_m_share * 615000, 2055: o_m_share * 615000, 2060: o_m_share * 615000},
        ...
        'windon':       {2020: o_m_share * 1778000, 2025: o_m_share * 1778000, 2030: o_m_share * 1778000, 2035: o_m_share * 1997284, 2040: o_m_share * 1778000, 2045: o_m_share * 1778000, 2050: o_m_share * 1778000, 2055: o_m_share * 1778000, 2060: o_m_share * 1778000},
    ...
    'investment_cost_charge_chfMW': { # only for storage technologies where charge and discharge capacity are distinct facilities as for hydrogen (charging capacity investment cost)
    ...
    'fixed_op_cost_chfMW': {
        ...
        # investable
        'pvrf':         {2020: 58000, 2025: 53000, 2030: 48000, 2035: 43000, 2040: 41000, 2045: 40000, 2050: 38000, 2055: 37000, 2060: 36000},
        'windon':       {2020: 75000, 2025: 73000, 2030: 71000, 2035: 69000, 2040: 67000, 2045: 65000, 2050: 63000, 2055: 61000, 2060: 59000},
    ...
    'input_cost_scenario_ZERO': {
        ...
        'css': {},
        'pvrf':   {2000: 0, 2019: 0, 2030:0 , 2035: 0, 2040: 0, 2050: 0, 2060: 0},
...
'investment_energy_cost_chfMWh': {   # capacity in MWh
    ...
    "investment_fuel_energy_cost_chfMWh": { #NOTE: all units are in MWh thermal energy (not m3 or barrel)
        ...
        "hydrogen":          {year:0 for year in [2040, 2050, 2030, 2035]},                     
    },
}
